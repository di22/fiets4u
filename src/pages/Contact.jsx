        ...
        <Layout>
            <div style={{ paddingTop: '80px', minHeight: '100vh' }}>
                <div className="container" style={{ padding: '4rem 2rem' }}>
                    <h1 style={{ fontSize: '3rem', marginBottom: '2rem', textAlign: 'center' }}>Get in <span className="text-gradient">Touch</span></h1>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem' }}>
                        <div className="glass-panel" style={{ padding: '2rem' }}>
                            ...
                            <address style={{ fontStyle: 'normal', color: 'var(--color-text-muted)', lineHeight: '1.8' }}>
                                <strong>Fietsmaker 4 You</strong><br />
                                Hagedoornweg 70a<br />
                                1031 BT Amsterdam<br />
                                The Netherlands
                            </address>

                            <h3 style={{ marginTop: '2rem', marginBottom: '1rem', color: 'var(--color-primary)' }}>Opening Hours</h3>
                        ...
                        <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', justifyContent: 'center', textAlign: 'center' }}>
                            ...
                            <h2 style={{ fontSize: '1.8rem', marginBottom: '1rem' }}>Message Us Directly</h2>
                            <p style={{ color: 'var(--color-text-muted)', lineHeight: 1.6, marginBottom: '2rem' }}>
                                The fastest way to reach us is via WhatsApp. Send us a message, a photo of your bike's issue, or just say hello!
                            </p>
                            <a
